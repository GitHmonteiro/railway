        ...
        <div>
          ...
          <div className="text-gray-600 mb-4 text-sm">
            ...
            <button
              ...
              className="text-pink-500 font-medium mt-2 block"
            >
              {verMais ? "Ver menos ▲" : "Ver mais ▼"}
            </button>
          </div>

          <div className="text-2xl font-bold text-pink-500 mb-6">R$ {product.price.toFixed(2).replace(".", ",")}</div>
          ...
          <div className="mt-8">
            ...
            <Button className="w-full bg-pink-500 hover:bg-pink-600 text-lg py-6" onClick={handleAddToOrder}>
