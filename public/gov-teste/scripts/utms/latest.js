      ...
      745: (e, t) => {
        ...
        class r {
          ...
          static decode(e) {
            ...
            return e.replace(
              n,
              (e) => Object.keys(r.map).find((t) => r.map[t] === e) || ""
            );
          }
        ...
        class o {
          static randomizePhoneNumberIfNecessary(e) {
            ...
            return e.includes("phone=")
              ? o.withReplaceQueryParam(e, "phone", a)
              : e.includes("wa.me")
              ? `https://wa.me/${a}?${e.split("?")[1]}`
              : e;
          }
          static insertAdIdInWppUrl(e, t) {
            var r;
            const n =
                null !== (r = o.getQueryParams(e).get("text")) && void 0 !== r
                  ? r
                  : "Olá",
              i = t.replace(/[^0-9]/g, ""),
  ...
  (() => {
    ...
    const i = {
      ...
      ignoreClasses:
        null ===
          ...
          : n.filter((e) => !!e),
      replaceLinks:
        null === (a = document.querySelector("[data-utmify-replace-links]")) ||
        void 0 === a
          ? void 0
          : a.getAttribute("data-utmify-replace-links"),
    ...
    class c {
      static addUtmParametersToUrl(e) {
        ...
        r.forEach((e, t) => a.append(t, e)),
          n.forEach((e, t) => a.append(t, e));
        const o = c.urlParametersWithoutDuplicates(a),
          l = c.simplifyParametersIfNecessary(t, o),
          s = i.replacePlusSignal
            ? l.toString().split("+").join("%20")
            : l.toString(),
          u = -1 === t.indexOf("?") ? "?" : "&";
        return `${t}${u}${s}`;
      }
      ...
      static getUtmParameters() {
        ...
        function r(e) {
          const r = t.get(e);
          if (null != r && "null" !== r && "undefined" !== r && "" !== r)
            return r;
        ...
        const a = r("utm_term"),
          ...
          c = (function (e) {
            const t = (function () {
              ...
              return null !== (e = null == r ? void 0 : r._id) && void 0 !== e
                ? e
                : null;
            })();
        ...
        d.set("utm_source", c),
          d.set("utm_campaign", u),
          d.set("utm_medium", s),
          d.set("utm_content", l),
          d.set("utm_term", a),
          i.isCartpanda &&
            d.set("cid", Math.round(1e11 * Math.random()).toString());
        const p = [c, u, s, l, a],
          v = n(p);
        i.isClickBank
          ? (d.set("aff_sub1", o.UrlRebuilder.removeSpecialCharacteres(c)),
            d.set(
              "aff_sub2",
              o.UrlRebuilder.removeSpecialCharacteres(u).replace(
                /\|(?=\d{10,}$)(?!.*\|)/,
                "cKBk"
              )
            ),
            d.set(
              "aff_sub3",
              o.UrlRebuilder.removeSpecialCharacteres(s).replace(
                /\|(?=\d{10,}$)(?!.*\|)/,
                "cKBk"
              )
            ),
            d.set(
              "aff_sub4",
              o.UrlRebuilder.removeSpecialCharacteres(l).replace(
                /\|(?=\d{10,}$)(?!.*\|)/,
                "cKBk"
              )
            ),
            d.set("aff_sub5", o.UrlRebuilder.removeSpecialCharacteres(a)))
          : i.preventSubIds ||
            (d.set("subid", o.UrlRebuilder.removeSpecialCharacteres(c)),
            d.set("sid2", o.UrlRebuilder.removeSpecialCharacteres(u)),
            d.set("subid2", o.UrlRebuilder.removeSpecialCharacteres(u)),
            d.set("subid3", o.UrlRebuilder.removeSpecialCharacteres(s)),
            d.set("subid4", o.UrlRebuilder.removeSpecialCharacteres(l)),
            d.set("subid5", o.UrlRebuilder.removeSpecialCharacteres(u)));
        const f = r("xcod"),
          h = r("src"),
          g = "" !== f ? f : h,
          y = (function (t, r) {
            ...
            function o(e, t, r) {
              ...
              return `${n(
                1 === i.length ? i[0] : i.slice(0, -1).join(o)
              )}${o}${l}`;
            }
        ...
        d.set("xcod", y),
          d.set("sck", y),
          null != h && "" !== h && d.set("src", h);
        const S = t.get("fbclid");
        return (
          null != S && "" !== S && d.set("fbclid", S),
          (() => {
            const e = (e) => null == e || "" === e,
              t = r("utm_source"),
              n = r("utm_medium"),
        ...
        document.querySelectorAll("a").forEach((t) => {
          ...
          if (
            !(
              ...
              t.href.includes("#") ||
              (null === (r = null == i ? void 0 : i.ignoreClasses) ||
              void 0 === r
                ? void 0
                : r.some((e) => t.classList.contains(e)))
            )
          ) {
            if (
              ((n = t.href),
              ...
              return (
                (t.href = o.UrlRebuilder.randomizePhoneNumberIfNecessary(
                  t.href
                )),
                void (t.href = o.UrlRebuilder.insertAdIdInWppUrl(
                  t.href,
                  null != r ? r : ""
                ))
              );
            ...
            (t.href = c.addUtmParametersToUrl(t.href)),
              i.replaceLinks &&
                (function (e, t) {
                  ...
                  a.setAttribute("data-replaced-element", "true"),
                    (a.innerHTML = e.innerHTML),
                    null === (n = e.parentNode) ||
                      void 0 === n ||
                      n.replaceChild(a, e);
                })(t, { property: "href", value: i.replaceLinks });
          }
        });
      }
      function t(e) {
        document.querySelectorAll("form").forEach((t) => {
          ...
          (e && d.every((e) => t.action.includes(e))) ||
            (null === (r = null == i ? void 0 : i.ignoreClasses) || void 0 === r
              ? void 0
              : r.some((e) => t.classList.contains(e))) ||
            ((t.action = c.addUtmParametersToUrl(t.action)),
            c.getUtmParameters().forEach((e, r) => {
      ...
      const r = (function () {
        ...
        const { fixShopifyTheme: _ } = i,
                  ...
                  (n =
                    null ===
                      (r =
                        null === window || void 0 === window
                          ? void 0
                          : window.Shopify) || void 0 === r
                      ? void 0
                      : r.theme) || void 0 === n
              ? void 0
              : n.schema_name,
          P =
            null !== (a = null == R ? void 0 : R.includes("Dropmeta")) &&
            void 0 !== a &&
            a,
          L =
            null !== (o = null == R ? void 0 : R.includes("Warehouse")) &&
            void 0 !== o &&
            o,
          E =
            null !== (l = null == R ? void 0 : R.includes("Classic®")) &&
            void 0 !== l &&
            l,
          A =
          ...
          T =
            ...
            m,
          $ =
            null !== (p = null == R ? void 0 : R.includes("Wareimadigital")) &&
            void 0 !== p &&
            p,
          j =
            null !== (v = null == R ? void 0 : R.includes("Mercado Livre")) &&
            void 0 !== v &&
            v,
          k =
          ...
          N =
            ...
            g,
          q =
            null !== (y = null == R ? void 0 : R.includes("Split")) &&
            void 0 !== y &&
            y,
          M =
            null !== (S = null == R ? void 0 : R.includes("WART")) &&
            void 0 !== S &&
            S,
          W =
            null !== (w = null == R ? void 0 : R.includes("Vogal")) &&
            void 0 !== w &&
            w,
          D =
            null !== (b = null == R ? void 0 : R.includes("Aurohra 2.0")) &&
            void 0 !== b &&
            b,
          V =
            null !== (U = null == R ? void 0 : R.includes("RAWART")) &&
            void 0 !== U &&
            U;
        return (
          _ ||
          ...
          i.ignoreAllIframes ||
            ...
            document.querySelectorAll("iframe").forEach((e) => {
              ...
              Object.values(s).some((t) => e.src.includes(t)) ||
                (null === (t = null == i ? void 0 : i.ignoreClasses) ||
                void 0 === t
                  ? void 0
    ...
    i.fastStart || "complete" === document.readyState
      ? v()
